...
- `cli-check.png` presents selected fields from actual local `doctor` output and the actual `select` result captured on 2026-09-19, using version 0.4.0 and Codex CLI 0.147.0 on macOS arm64. It is a typeset terminal-output illustration, not a screenshot of the Codex app.
